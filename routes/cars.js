...
router.post("/nuevoauto", [
    ...
    check("modelo").not().isEmpty().withMessage("El modelo del auto es obligatorio").not().isNumeric().withMessage("El modelo debe ser numérico"),
...
router.put("/actualizar/:id", [
    ...
    check("color").not().isEmpty().withMessage("El color del auto es obligatorio"),
    check("precio").not().isEmpty().withMessage("El precio del auto es obligatorio").not().isNumeric().withMessage("El precio debe ser numérico")
], carsController.putCar)

router.delete("/eliminarAuto/:id", [
    check("marca").not().isEmpty().withMessage("La marca del auto es obligatoria"),
    check("tipo").not().isEmpty().withMessage("El tipo del auto es obligatorio"),
    check("modelo").not().isEmpty().withMessage("El modelo del auto es obligatorio").not().isNumeric().withMessage("El modelo debe ser numérico"),
    check("color").not().isEmpty().withMessage("El color del auto es obligatorio"),
